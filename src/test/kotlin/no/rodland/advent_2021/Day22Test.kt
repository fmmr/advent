...
internal class Day22Test {
    ...
    @Test
    fun `1_test_2`() {
        report(test.testPart1.copy(data = testData2, expected = 590784L))
    }

    @Test
    fun `2_test_3`() {
        report(test.testPart2.copy(data = testData3, expected = 2758514936282235L))
    }
    ...
    @Slow(1200)
    fun `1_live_naive`() {
        report(test.livePart1.copy(function = Day22::partOneNaive, numTests = 1))
    }

    @Test
    fun `1_test_naive`() {
        report(test.testPart1.copy(function = Day22::partOneNaive, numTests = 1))
    }
