...
private fun partOne() {
    var list2 = "/Users/frerodla/projects/advent/src/input_2.txt".readFileMutable()
    var list3 = "/Users/frerodla/projects/advent/src/input_2.txt".readFileMutable()
...
private fun numInList(list: MutableList<String>, chr: Char, n: Int): MutableList<String> {
    return list.filter { str -> !charsIsN(str, chr, n) }.toMutableList()
}
